...
fun AppNavigation(viewModel: MainViewModel, context: Context) {
    ...
    NavHost(
        ...
        composable(NFCSysScreen.Login.name) { LoginScreen(navController, viewModel, context) }
        ...
        composable(NFCSysScreen.Recovery.name) { RecoveryScreen(navController, viewModel, context) }
